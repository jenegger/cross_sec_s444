...
//const Double_t beta_given = 0.706470; //with ingoing 12C 384.6533 MeV
//const Double_t gamma_given = 1.41294; //corresponding gamma for 384.6533 MeV/u
//const Double_t beta_given = 0.703945; //with ingoing 12C 380 MeV
//const Double_t gamma_given = 1.40795; //corresponding gamma for 380 MeV/u
...
if (runnr.compare("0082_0001") == 0 || runnr.compare("0083_0001") == 0 || runnr.compare("0078_0001") == 0){
